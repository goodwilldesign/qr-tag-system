        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm py-16 text-center">
          {tab === 'active' ? (
            <>
              ...
              <p className="text-slate-400 text-sm mt-1 mb-6">Import all 8 existing GetURQR products in one click, or add your own.</p>
